...
function crearModalTractament() {
	...
	html += '<div id="seleccio-finca" class="form-group"><label>Selecciona Finques</label><div id="tractament-finques-checks" style="display:flex; flex-direction:column; gap:4px; margin-top:8px;"></div></div>';
...
async function obrirModalTractament() {
    ...
    '<input type="checkbox" value="' + finca + '" onchange="actualitzarParcellesSeleccionades()" style="margin:0;flex-shrink:0;">' +
    finca + '</label>';
});
